...
if (currentTab == "runes"){
  ...
  //  document.getElementById("rune1level").textContent = "Level: " + player.runelevels[0] + "/" + (500 + player.researches[78])
    ...
    document.getElementById("rune1exp").textContent = "+1 in " + format(calculateRuneExpToLevel(0) - player.runeexp[0]) + " EXP" 
    document.getElementById("rune2exp").textContent = "+1 in " + format(calculateRuneExpToLevel(1) - player.runeexp[1]) + " EXP"
    document.getElementById("rune3exp").textContent = "+1 in " + format(calculateRuneExpToLevel(2) - player.runeexp[2]) + " EXP"
    document.getElementById("rune4exp").textContent = "+1 in " + format(calculateRuneExpToLevel(3) - player.runeexp[3]) + " EXP"
    document.getElementById("rune5exp").textContent = "+1 in " + format(calculateRuneExpToLevel(4) - player.runeexp[4]) + " EXP"
