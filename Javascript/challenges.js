function challengeDisplay(i,changefocus, automated) {
    ...
    if(i == 1 && challengefocus == 1){
        ...
        d.textContent = "Goal: Gain " + format(calculateChallengeRequirements("one")) + " Coins in challenge."
    ...
    if(i == 2 && challengefocus == 2){
        ...
        d.textContent = "Goal: Gain " + format(calculateChallengeRequirements("two")) + " Coins in challenge."
    ...
    if(i == 3 && challengefocus == 3){
        ...
        d.textContent = "Goal: Gain " + format(calculateChallengeRequirements("three")) + " Coins in challenge."
    ...
    if(i == 4 && challengefocus == 4){
        ...
        d.textContent = "Goal: Gain " + format(calculateChallengeRequirements("four")) + " Coins in challenge."
    ...
    if(i == 5 && challengefocus == 5){
        ...
        d.textContent = "Goal: Gain " + format(calculateChallengeRequirements("five")) + " Coins in challenge."
